...
@ComponentScan(basePackages = { "com.ahsanb.auth.tenant.dao",
        "com.ahsanb.auth.tenant.entities" })
@EnableJpaRepositories(basePackages = {
        "com.ahsanb.auth.tenant.dao",
        "com.ahsanb.auth.tenant.services" }, 
...
public class TenantDatabaseConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(
        ...
        emfBean.setPackagesToScan(
        new String[] { "com.ahsanb.auth"});
        //emfBean.setPackagesToScan("com.ahsanb.auth.tenant");
